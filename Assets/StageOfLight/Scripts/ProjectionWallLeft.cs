...
public class ProjectionWallLeft : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        // Maintain the camera's absolute rotation (specifically 270 degrees on the Y-axis)
        Projection.transform.rotation = Quaternion.Euler(0f, 270f, 0f); // This ensures the camera is facing left
